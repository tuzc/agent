...
OUT = Path("data/market_sentiment_20260727_20260731.csv")
RAW_DIR = Path("data/market_sentiment_raw_20260727_20260731")
    ...
    for attempt in range(4):
        try:
            response = session.post(
                URL, params=params, data=payload, headers=HEADERS, timeout=25
            )
...
def main() -> None:
    ...
    fieldnames = [
        "date", "market_turnover_raw", "sh_turnover_raw", "up_count",
        "down_count", "flat_count", "limit_up_count", "limit_down_count",
        "actual_limit_up_count", "actual_limit_down_count", "response_date",
    ]
